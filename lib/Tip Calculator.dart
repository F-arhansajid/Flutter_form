...
import 'package:mblapp/SimpleinputFild.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // const Spacer(),
                /*  Text("Total Bill",  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700,color: textBlock)),
        ...
        decoration: InputDecoration(
            ...
            suffix: const Icon(Icons.attach_money, color: textBlock),
            filled: true,
